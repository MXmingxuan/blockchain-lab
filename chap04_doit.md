...
### 6.  "巨鲸警报" 监控器 (Whale Alert Lite)
- 你在大纲里学到了“全节点”可以看到所有交易。其实有很多公开的 API (如 Blockchain.com 或 Etherscan) 提供了这些数据。

功能：

- 写一个脚本，每 10 分钟请求一次最新的区块数据。

- 筛选出金额大于 100 BTC 的交易。

- 输出： 当发现大额转账时，打印一条警报：“🚨 发现巨鲸移动！金额：500 BTC”。

- 投资意义： 链上大额转账往往是市场剧烈波动的前兆（比如大户充值进交易所准备砸盘）。这是链上数据分析 (On-chain Analysis) 的入门。
